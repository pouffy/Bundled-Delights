package com.pouffydev.bundledelight.content.food;
...
public class FoodValues {
    ...
    public static final FoodProperties MEAD = (new FoodProperties.Builder()).nutrition(6).saturationMod(0.1F).effect(() -> {
        return new MobEffectInstance(sweetHeart, 6000, 0);
    }, 1.0F).alwaysEat().build();
    public static final FoodProperties RICE_WINE = (new FoodProperties.Builder()).effect(() -> {
        return new MobEffectInstance(satisfaction, 6000, 0);
    }, 1.0F).alwaysEat().build();
    ...
    public static final FoodProperties SACCHARINE_RUM = (new FoodProperties.Builder()).nutrition(6).saturationMod(0.1F).effect(() -> {
        return new MobEffectInstance(sweetHeart, 9600, 1);
    }, 1.0F).alwaysEat().build();
    public static final FoodProperties PALE_JANE = (new FoodProperties.Builder()).effect(() -> {
        return new MobEffectInstance(satisfaction, 9600, 1);
    }, 1.0F).alwaysEat().build();
