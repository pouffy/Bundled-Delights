...
public class RespiteMDCompatItems {
    ...
    static{
        ...
        GREEN_TEA_CUP = ITEMS.register("green_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.GREEN_TEA, respite);
        });
        LONG_GREEN_TEA_CUP = ITEMS.register("long_green_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.LONG_GREEN_TEA, respite, true);
        });
        STRONG_GREEN_TEA_CUP = ITEMS.register("strong_green_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.STRONG_GREEN_TEA, respite, true);
        });
        YELLOW_TEA_CUP = ITEMS.register("yellow_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.YELLOW_TEA, respite);
        });
        LONG_YELLOW_TEA_CUP = ITEMS.register("long_yellow_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.LONG_YELLOW_TEA, respite, true);
        });
        STRONG_YELLOW_TEA_CUP = ITEMS.register("strong_yellow_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.STRONG_YELLOW_TEA, respite, true);
        });
        BLACK_TEA_CUP = ITEMS.register("black_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.BLACK_TEA, respite);
        });
        LONG_BLACK_TEA_CUP = ITEMS.register("long_black_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.LONG_BLACK_TEA, respite, true);
        });
        STRONG_BLACK_TEA_CUP = ITEMS.register("strong_black_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.STRONG_BLACK_TEA, respite, true);
        });
        ROSE_HIP_TEA_CUP = ITEMS.register("rose_hip_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.ROSE_HIP_TEA, respite);
        });
        STRONG_ROSE_HIP_TEA_CUP = ITEMS.register("strong_rose_hip_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.STRONG_ROSE_HIP_TEA, respite, true);
        });
        DANDELION_TEA_CUP = ITEMS.register("dandelion_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.DANDELION_TEA, respite);
        });
        LONG_DANDELION_TEA_CUP = ITEMS.register("long_dandelion_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.LONG_DANDELION_TEA, respite, true);
        });
        PURULENT_TEA_CUP = ITEMS.register("purulent_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.PURULENT_TEA, respite);
        });
        STRONG_PURULENT_TEA_CUP = ITEMS.register("long_purulent_tea_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.LONG_PURULENT_TEA, respite, true);
        });
        COFFEE_CUP = ITEMS.register("coffee_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.COFFEE, respite);
        });
        STRONG_COFFEE_CUP = ITEMS.register("strong_coffee_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.STRONG_COFFEE, respite, true);
        });
        LONG_COFFEE_CUP = ITEMS.register("long_coffee_cup", () -> {
            return new CompatEffectDrink(compatEffectDrink(), FoodValues.LONG_COFFEE, respite, true);
        });
    }
}
