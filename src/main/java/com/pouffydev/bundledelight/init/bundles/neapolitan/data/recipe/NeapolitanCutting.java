...
public class NeapolitanCutting extends BundleRecipeGen {
    ...
    private static void cutMiscellaneous(Consumer<FinishedRecipe> consumer) {
        RecipeShortcuts.powder(NeapolitanItems.powderedAdzukiBeans.get(), com.teamabnormals.neapolitan.core.registry.NeapolitanItems.ROASTED_ADZUKI_BEANS.get()).build(consumer);
        RecipeShortcuts.powder(NeapolitanItems.powderedMintLeaves.get(), com.teamabnormals.neapolitan.core.registry.NeapolitanItems.MINT_LEAVES.get()).build(consumer);
        RecipeShortcuts.powder(NeapolitanItems.powderedVanilla.get(), com.teamabnormals.neapolitan.core.registry.NeapolitanItems.DRIED_VANILLA_PODS.get()).build(consumer);
