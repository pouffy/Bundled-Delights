...
public class NeapolitanCrafting extends BundleRecipeGen {
    ...
    private static void recipesFoodBlocks(Consumer<FinishedRecipe> consumer) {
        ...
        RecipeShortcuts.compactCakeFromSlices(NeapolitanBlocks.whiteStrawberryCake.get(), NeapolitanItems.whiteStrawberryCakeSlice.get()).save(consumer, new ResourceLocation(BundledDelight.MODID, "food/white_strawberry_cake_from_slices"));
