...
public class CuttingBoardRecipeBuilder {
    ...
    private CuttingBoardRecipeBuilder(Ingredient ingredient, Ingredient tool, ItemLike mainResult, int count, float chance, String requiredBundle) {
    ...
    public static CuttingBoardRecipeBuilder cuttingRecipe(Ingredient ingredient, Ingredient tool, ItemLike mainResult, int count, String requiredBundle) {
        return new CuttingBoardRecipeBuilder(ingredient, tool, mainResult, count, 1.0F, requiredBundle);
    }
    
    public static CuttingBoardRecipeBuilder cuttingRecipe(Ingredient ingredient, Ingredient tool, ItemLike mainResult, int count, int chance, String requiredBundle) {
        return new CuttingBoardRecipeBuilder(ingredient, tool, mainResult, count, (float)chance, requiredBundle);
    }
    
    public static CuttingBoardRecipeBuilder cuttingRecipe(Ingredient ingredient, Ingredient tool, ItemLike mainResult, String requiredBundle) {
        return new CuttingBoardRecipeBuilder(ingredient, tool, mainResult, 1, 1.0F, requiredBundle);
    }
    ...
    public void build(Consumer<FinishedRecipe> consumerIn, ResourceLocation id) {
        consumerIn.accept(new CuttingBoardRecipeBuilder.Result(id, this.ingredient, this.tool, this.results, this.soundEventID == null ? "" : this.soundEventID, this.requiredBundle));
    }
    ...
    public static class Result implements FinishedRecipe {
        ...
        public Result(ResourceLocation idIn, Ingredient ingredientIn, Ingredient toolIn, List<ChanceResult> resultsIn, String soundEventIDIn, String requiredBundle) {
            this.id = idIn;
