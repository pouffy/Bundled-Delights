package com.pouffydev.bundledelight.foundation.lang;
...
public class Lang {
    public static MutableComponent translateDirect(String key, Object... args) {
        return Components.translatable(BundledDelight.MODID + "." + key, resolveBuilders(args));
    }
    ...
    public static LangBuilder builder() {
        return new LangBuilder(BundledDelight.MODID);
    }
