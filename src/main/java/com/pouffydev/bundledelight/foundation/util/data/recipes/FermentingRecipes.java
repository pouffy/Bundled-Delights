...
import com.pouffydev.bundledelight.foundation.util.data.builder.brewinandchewin.KegRecipeBuilder;
...
public class FermentingRecipes {
    ...
    private static void fermentBrews(Consumer<FinishedData> consumer) {
        KegRecipeBuilder.kegRecipe((ItemLike) BrewinMDCompatItems.BEER_SWIG.get(), 1, 12000, 0.6F, (ItemLike) BrewinMDCompatItems.COPPER_TANKARD.get(), fromMD("WATER_CUP"), 3).addIngredient(Items.WHEAT).addIngredient(Items.WHEAT).addIngredient(Items.WHEAT).build(consumer);
        KegRecipeBuilder.kegRecipe((ItemLike) BrewinMDCompatItems.VODKA_SWIG.get(), 1, 12000, 0.6F, (ItemLike) BrewinMDCompatItems.COPPER_TANKARD.get(), fromMD("WATER_CUP"), 3).addIngredient(Items.POTATO).addIngredient(Items.POTATO).addIngredient(Items.POTATO).addIngredient(Items.WHEAT).build(consumer);
        ...
        KegRecipeBuilder.kegRecipe((ItemLike) BrewinMDCompatItems.RICE_WINE_SWIG.get(), 1, 12000, 0.6F, (ItemLike) BrewinMDCompatItems.COPPER_TANKARD.get(), fromMD("WATER_CUP"), 3).addIngredient((ItemLike) ModItems.RICE.get()).addIngredient((ItemLike)ModItems.RICE.get()).addIngredient((ItemLike)ModItems.RICE.get()).addIngredient((ItemLike)ModItems.RICE.get()).build(consumer);
        KegRecipeBuilder.kegRecipe((ItemLike) BrewinMDCompatItems.EGG_GROG_SWIG.get(), 1, 12000, 0.6F, (ItemLike) BrewinMDCompatItems.COPPER_TANKARD.get(), fromMD("MILK_CUP"), 3).addIngredient(Items.EGG).addIngredient(Items.EGG).addIngredient((ItemLike)ModItems.CABBAGE_LEAF.get()).addIngredient(Items.SUGAR).build(consumer);
        ...
        KegRecipeBuilder.kegRecipe((ItemLike) BrewinMDCompatItems.GLITTERING_GRENADINE_SWIG.get(), 1, 12000, 0.6F, (ItemLike) BrewinMDCompatItems.COPPER_TANKARD.get(), fromMD("WATER_CUP"), 2).addIngredient(Items.GLOW_BERRIES).addIngredient(Items.GLOW_INK_SAC).addIngredient(Items.GLOWSTONE_DUST).addIngredient(Items.GLOW_BERRIES).build(consumer);
        ...
        KegRecipeBuilder.kegRecipe((ItemLike) BrewinMDCompatItems.ROOT_BEER_SWIG.get(), 1, 12000, 0.6F, (ItemLike) BrewinMDCompatItems.COPPER_TANKARD.get(), fromMD("WATER_CUP"), 3).addIngredient(Items.HANGING_ROOTS).addIngredient(Items.SUGAR).addIngredient(ModItems.TREE_BARK.get()).addIngredient(Items.GLOW_BERRIES).build(consumer);
        ...
        KegRecipeBuilder.kegRecipe((ItemLike) BrewinCompatItems.KOMBUCHA_GLASS.get(), 1, 12000, 0.6F, (ItemLike) BrewinCompatItems.GLASS_TANKARD.get(), (ItemLike) fromFR("GREEN_TEA"), 3).addIngredient(Items.BEETROOT).addIngredient(Items.CARROT).addIngredient(RespiteCompatItems.POWDERED_BLACK_TEA_LEAVES.get()).addIngredient(Items.SWEET_BERRIES).build(consumer);
    ...
    private static void fermentFoods(Consumer<FinishedData> consumer) {
        KegRecipeBuilder.kegRecipe((ItemLike) fromN("VANILLA_FUDGE"), 4, 12000, 0.6F, Items.MILK_BUCKET, 5).addIngredient(Items.SUGAR).addIngredient(fromN("DRIED_VANILLA_PODS")).addIngredient(fromN("DRIED_VANILLA_PODS")).build(consumer);
    }
