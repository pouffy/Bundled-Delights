...
public class BrewingRecipes {
    ...
    private static void cookMiscellaneous(Consumer<FinishedRecipe> consumer) {
        ...
        KettleRecipeBuilder.kettleRecipe((ItemLike) RespiteMDCompatItems.DANDELION_TEA_CUP.get()).addIngredient((ItemLike)Items.DANDELION).addIngredient(ModTags.TEA_POWDER).build(consumer);
