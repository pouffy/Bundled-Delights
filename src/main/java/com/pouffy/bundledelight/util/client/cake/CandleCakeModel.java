...
public class CandleCakeModel {
    ...
    public static void generateJson(String type, String colour) {
        ...
        textures.addProperty("candle", "minecraft:block/" + colour + "_candle");
        ...
        String fileName = "src/main/resources/generated/assets/bundledelight/models/block/" + colour + "_" + type + "_candle_cake.json";
