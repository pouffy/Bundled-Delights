...
public class CopperBoozeItem extends DrinkableItem {
    protected final int potency;
    protected final int duration;

    public CopperBoozeItem(int potency, int duration, Item.Properties properties) {
        super(properties);
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level worldIn, List<Component> tooltip, TooltipFlag flagIn) {
        ...
        if (stack.sameItem(new ItemStack((ItemLike) BrewinMDItems.DREAD_NOG_SWIG.get()))) {
